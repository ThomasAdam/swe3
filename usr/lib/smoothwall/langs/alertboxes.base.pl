...
'credits.cgi' 		=> 'SmoothWall Express' . $tr{'version'} . ' ' . $version . '-' . ' ' . $webuirevision,
...
'alcateladslfw.cgi' 	=> 'Upload firmware to enable use of an Alcatel/Thomson Speedtouch Home USB ADSL modem, nicknamed the \'frog\' or \'stingray\'. Download the \'Speedtouch USB Firmware\' tarball, unpack it, and upload the mgmt.o file using this form.',
